// src/lib.rs
/*
 * Core library for MicropythonEsp
 */
...
#[derive(Debug)]
pub struct MicropythonEspProcessor {
    verbose: bool,
    processed_count: usize,
}

impl MicropythonEspProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting MicropythonEsp processing");
    
    let mut processor = MicropythonEspProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = MicropythonEspProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = MicropythonEspProcessor::new(false);
